...
class NewsController {
    ...
    create(req, res) {
        ...
        newsService_1.default.create(vm)
            .then(vm => helper_1.default.sendResponse(res, HttpStatus.OK, "Noticia cadastrada com sucesso"))
            .catch(error => console.error.bind(console, `Error ${error}`));
    }
    update(req, res) {
        const _id = req.params.id;
        ...
        newsService_1.default.update(_id, news)
            .then((news) => helper_1.default.sendResponse(res, HttpStatus.OK, `${news.title} foi atualizado com sucesso`))
            .catch(error => console.error.bind(console, `Error ${error}`));
    }
    delete(req, res) {
        const _id = req.params.id;
